...
whoScored(['Davies', 'Muller', 'Lewandowski', 'Kimmich']);
whoScored(['Davies', 'Muller']);
...
//------BONUS--------
let average = 0;
const averageOdds = function (numberOdds) {
  for (let i = 0; i < numberOdds.length; i++) {
    average += numberOdds[i];
  }
  console.log(average / numberOdds.length);
};

// averageOdds(oddsPoint);
